...
namespace SperoSophia
{
    ...
    public static class NETCoreAssemblyExtension
    {
        ...
        public static IEnumerable<Assembly> GetReferencingAssemblies(string assemblyName)
        {
            ...
            var mainAssemnly = Assembly.GetEntryAssembly();
            if (!assemblies.Any(x => x.FullName == mainAssemnly.FullName))
            {
                assemblies.Add(mainAssemnly);
            }
            return assemblies;
        }
        ...
        {
            return library.Name == (assemblyName) || library.Dependencies.Any(d => d.Name == "Panda");
        }
